...
// Mock Data for secondary panels
            ...
            {props.cameras.map((cam) => (
              ...
              >
                ...
                <div className="px-3 pb-3">
                  <h3 className={`font-semibold text-base mb-1 ${props.selectedCameraId === cam.id ? "text-white" : "text-slate-800"}`}>
                    {cam.name}
                  </h3>
                  <p className={`text-xs flex items-center gap-1.5 ${props.selectedCameraId === cam.id ? "text-indigo-100" : "text-slate-500"}`}>
            ...
            <GlassPanel className="p-8">
              <div className="flex items-center justify-between mb-8">
                <div>
                  ...
                  <p className="text-sm text-slate-500">{props.selectedCamera?.name || "No Camera Selected"}</p>
                </div>
              ...
              <div className="flex justify-center mb-10">
                <Joystick 
                  ...
                  className="bg-slate-100 border-4 border-white shadow-inner rounded-full [&>div>div]:bg-indigo-500"
                />
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between text-sm font-medium text-slate-600">
                    ...
                    <Button variant="ghost" size="sm" onClick={props.onFocusAuto} className="h-6 px-2 text-xs text-indigo-600 hover:text-indigo-700 hover:bg-indigo-50">Auto Focus</Button>
                  </div>
                  <Slider 
                    value={focusValue} 
                ...
                {Array.from({ length: 16 }).map((_, i) => {
                  ...
                  return (
                    <button 
                      ...
                      className="h-16 rounded-2xl bg-slate-50 border border-slate-100 hover:bg-white hover:shadow-md hover:border-indigo-100 transition-all flex flex-col items-center justify-center gap-1 text-slate-600 hover:text-indigo-600 group relative"
                      title="Left-click to recall, Right-click to store"
                    >
                      <span className="text-xs font-bold text-slate-400 group-hover:text-indigo-300 transition-colors">{(i + 1).toString().padStart(2, '0')}</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <GlassPanel className="p-6 flex flex-col">
                ...
                <Link href="/switcher" className="mt-4 block w-full">
                  <Button variant="outline" className="w-full rounded-xl border-slate-200 text-slate-600 hover:bg-slate-50">View Full Switcher</Button>
                </Link>
              </GlassPanel>
              ...
              <GlassPanel className="p-6 flex flex-col">
                ...
                <Link href="/mixer" className="mt-4 block w-full">
                  <Button variant="outline" className="w-full rounded-xl border-slate-200 text-slate-600 hover:bg-slate-50">View Full Mixer</Button>
                </Link>
              </GlassPanel>
            </div>
