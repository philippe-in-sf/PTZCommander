              ...
              className={cn(
                ...
                mode === 'store'
                  ...
                  : hasData
                    ...
                    : "border-slate-300 dark:border-slate-800 bg-slate-400/30 dark:bg-slate-900/30 text-slate-400 dark:text-slate-600 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-600 dark:hover:text-slate-400"
              )}
