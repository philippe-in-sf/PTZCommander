...
export default function MobilePage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col" style={{ maxWidth: "100vw", overflow: "hidden" }}>
      ...
      <div className="flex border-b border-slate-200 dark:border-slate-800 bg-slate-400/50 dark:bg-slate-950/50 shrink-0">
        {(["control", "scenes", "switcher"] as const).map(tab => (
          <button
            ...
            className={cn(
              ...
              activeTab === tab ? "text-cyan-600 dark:text-cyan-400 border-b-2 border-cyan-500 bg-slate-300/50 dark:bg-slate-900/50" : "text-slate-400 dark:text-slate-500"
            )}
