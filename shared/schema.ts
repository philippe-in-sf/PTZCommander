...
export const displayDevices = pgTable("display_devices", {
  ...
  samsungToken: text("samsung_token"),
  samsungPort: integer("samsung_port").default(8002),
  samsungModel: text("samsung_model"),
  hisensePort: integer("hisense_port").default(36669),
  hisenseUseSsl: boolean("hisense_use_ssl").notNull().default(true),
  hisenseUsername: text("hisense_username").default("hisenseservice"),
  hisensePassword: text("hisense_password").default("multimqttservice"),
  hisenseClientName: text("hisense_client_name").default("PTZCommander"),
  hisenseModel: text("hisense_model"),
  hisensePaired: boolean("hisense_paired").notNull().default(false),
  status: text("status").notNull().default("offline"),
...
export const insertCameraSchema = createInsertSchema(cameras).omit({
  ...
  previewType: z.enum(["none", "snapshot", "mjpeg", "rtsp", "rtp", "webrtc", "browser"]).optional(),
